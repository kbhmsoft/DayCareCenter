...
class Site2 extends Frontend_Controller {
         ...
         public function newapplication($id)
      {
         ...
         // //Dynamic DB Name
            ...
            //Member table 
               $members_data  = $_POST['members'];
               // echo "<pre>";
               unset($members_data[0]);
               // print_r($members_data); exit();
               $members_data_ = array(
                  // 'parents_id'         => $this->userSessID,
                  // 'registrations_id'   => $insert_id,
                  'member_types_id'    => 1,
               ...
               // echo "</pre>";
               // exit;
               $this->Site_model->edit_member('demo_daycares_1.members',$id,'id',$members_data);
               // $insert_member_id = $this->Site_model->last_insert_id();
