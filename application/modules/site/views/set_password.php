   ...
   <div class="col-md-6 main-content"> 
      <div class="col-md-12 col-sm-12">   
         <fieldset class="scheduler-border">
            <legend class="scheduler-border"> পাসওয়ার্ড সেট করুন </legend>

            <form action="<?=base_url('index.php/set_password')?>" method="post" enctype="multipart/form-data" id="jsvalidation">
