...
<div class="row">
   ...
   <div class="col-md-9 main-content" style="padding: 15px 15px 15px 15px"> 
          ...
          <div>
            ...
            <form action="<?=base_url('index.php/new-application/'.$student_info->day_cares_id.'/'.$student_info->member_id)?>" method="post" enctype="multipart/form-data" id="jsvalidation" style="font-family: 'arial'">
               ...
               <div class="col-md-12" style="background: #fff;padding-top:30px;">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="row form-row">   
                     ...
                     <fieldset class="scheduler-border">
                        <legend class="scheduler-border">পার্ট-৫: শিশুর অসুস্থতা নীতি সংক্রান্ত অঙ্গীকারনামা</legend>
                     ...
                     <fieldset class="scheduler-border">
                        <legend class="scheduler-border">পার্ট-৬: জরুরি চিকিৎসা সেবা প্রদানের সম্মতি</legend>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="col-md-8">
                                 শিশুর নাম:  ____________________________________________<br><br> মাতা-পিতা বা অভিভাবকের স্বাক্ষর: ____________________ 
                              </div>
                              <div class="col-md-4">
                                     <br> <br> তারিখ: _______________ 
                              </div>
                     ...
                     <fieldset class="scheduler-border">
                        <legend class="scheduler-border">পার্ট-৭: শিশুর কার্যাবলী ও বিশেষ অনুষ্ঠানের ছবি ও তথ্যচিত্র ব্যবহারের অনুমতি</legend>
                        আমি আমার শিশু  ...................................................................... এর  ছবি ও তথ্যচিত্র  ব্যবহারে সম্মতি দিলাম।
                        <table>
                           <tr>
                        ...
                        <br>মাতা-পিতা বা অভিভাবক স্বাক্ষর: <br>
                         তারিখ:
