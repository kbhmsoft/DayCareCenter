      ...
      <div class="col-md-12">
         <div class="box box-primary">
            ...
            <div class="box-body">
               ...
               <?php endif; ?>
               <table id="example1" class="table" style="font-size: large;">
                  <thead>
                     <tr>
                        <th width="20">নং</th>
                        <th>শিরোনাম</th>
                  ...
                  <tbody>
                     ...
                     $sl=0;
                        ...
                        <tr>
                           ...
                           <a href="<?=base_url('index.php/adminpanel/day_care/details/'.$row->id)?>" class="btn btn-info btn-xs">বিস্তারিত</a>
                          <!--  <a href="<?=base_url('index.php/adminpanel/day_care/dc_login/'.$row->id)?>" class="btn btn-info btn-xs">লগইন</a> -->
                           <?php /*
                              <div class="btn-group">
