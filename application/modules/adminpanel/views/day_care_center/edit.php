    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('index.php/adminpanel/news/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All News</a>
          <a href="<?=base_url('index.php/adminpanel/news/details/'.$info->id)?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Details News</a>
          <a href="<?=base_url('index.php/adminpanel/news/add')?>" class="btn btn-info btn-xs pull-right"> Add News</a> 
        </div>        
