   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-primary">
            ...
            <?php echo form_open_multipart("index.php/adminpanel/budget/advance_bill_add");?>
            <div class="box-body">
               ...
               <div class="row form-row">
                  <div class="col-md-6 col-md-offset-2">
                     <div class="form-group">
                        <label>অগ্রিম বিলের শিরোনাম</label>
               ...
               <div class="row form-row">
                  <div class="col-md-12 appointmentDiv"> 
                     <h4 style="text-align: center;">অগ্রিম বিলের তালিকা</em></h4>
                     <style type="text/css">
