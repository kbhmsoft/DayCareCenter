      ...
      <div class="col-md-12">
         <div class="box box-primary">
            <div class="box-header with-border">
               ...
               <a href="<?=base_url('index.php/adminpanel/member')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Member List</a>          
            </div>        
            <?php 
            $attributes = array('id' => 'jsvalidation');
            echo form_open_multipart("index.php/adminpanel/member/nominee", $attributes);
            ?>
            <div class="box-body">
