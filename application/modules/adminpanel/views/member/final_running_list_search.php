         ...
         <div class="box box-primary">
            ...
            <div style="float: right; margin-right: 10px">
               <form class="form-inline" action="<?=base_url('index.php/adminpanel/member/verified_request_search/1');?>" method="GET"> 
                     ...
                     <div class="input-group">
                       <input type="text" name="date_dirth" class="form-control" placeholder="জন্ম তারিখ" id="txtSearch"/>
                     </div>
                     <div class="input-group">
                       <input type="text" name="date_joining" class="form-control" placeholder="যোগদানের তারিখ" id="txtSearch"/>
