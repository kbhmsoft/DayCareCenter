      ...
      <div class="box box-primary">
        <div class="box-header with-border">
         ...
         <?php if($info->is_paid == 1  && $info->status != 2){ ?> 
          <a href="<?=base_url('index.php/adminpanel/member/complete_status/'.$info->id)?>" target="_blank" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;" onclick="return confirm('Are you sure?')">Completed</a>
        <?php } ?>
              ...
              <fieldset>
                ...
                <table class="tg" style="text-align: left;">  
                  ...
                  <tr>
                    ...
                    <td class="tg-0pky"><?=$info->bcg == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  <!-- </tr>
                  <tr> -->
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">পেন্টা:</td>
                    <td class="tg-0pky"><?=$info->penta == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  </tr>
                  <tr>
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">পিসিবি:</td>
                    <td class="tg-0pky"><?=$info->pcb == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  <!-- </tr>
                  <tr> -->
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">ওপিবি:</td>
                    <td class="tg-0pky"><?=$info->opb == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  </tr>
                  <tr>
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">আইপিবি:</td>
                    <td class="tg-0pky"><?=$info->ipb == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  <!-- </tr>
                  <tr> -->
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">এমআর:</td>
                    <td class="tg-0pky"><?=$info->mr == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  </tr>
                  <tr>
                    <td  scope="col" width="30" class="tg-9czc" style="font-weight: bolder;">হাম:</td>
                    <td class="tg-0pky"><?=$info->ham == 0 ? 'এখনো দেওয়া হয়নি' : 'দেওয়া হয়েছে'?></td>
                  </tr>
                </table>
              </fieldset>
              <fieldset>
