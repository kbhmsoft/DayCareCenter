                              ...
                              */ ?>
                              ...
                              <div class="col-md-8">
                                 <div class="form-group">
                                    ...
                                    <input type="radio" name="is_verified" value="1" id="selectedV" <?=set_value('is_verified')==1?'checked':'checked';?>>অনুমোদিত
                                    <input type="radio" name="is_verified" value="0" <?=set_value('is_verified')==0?'':'';?>>অননুমোদিত
                                 </div>  
                              </div>
                              <div class="col-md-4">
