                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="<?=base_url('adminpanel/category/details/'.$row->id)?>">Details</a></li> -->
                        <li><a href="<?=base_url('adminpanel/gallerycategory/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('adminpanel/gallerycategory/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this category?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
