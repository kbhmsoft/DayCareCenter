      ...
      <div class="col-md-12">
         <div class="box box-primary">
            <div class="box-header with-border">
               ...
               <a href="<?=base_url('index.php/adminpanel/day_care_others')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Daycare Center List</a>
            </div>        
            <?php //echo validation_errors(); ?>
            <?php echo form_open_multipart("index.php/adminpanel/day_care_others/edit/$info->id");?>
            <div class="box-body">            
               ...
               <div class="row">
                  <div class="col-md-8">
                     <div class="form-group">
                        ...
                        echo form_dropdown('owner_id', $organization, set_value('owner_id', $info->owner_id), $more_attr);
                        ?>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea class="form-control" name="address" rows="3" cols="98"><?=set_value('address', $info->address)?></textarea>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">  
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="officer_designation" value="<?=set_value('officer_designation', $info->officer_designation)?>">
                     </div>  
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      <label>Daycare Type</label>
                        ...
                        <?php
                        $more_attr = 'class="form-control input-sm"';
                        echo form_dropdown('type_id', $daycare_type, set_value('type_id', $info->type_id), $more_attr);
                        ?>
                     </div>                  
                  </div>
               </div>
