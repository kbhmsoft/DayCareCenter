    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('index.php/adminpanel/slider/add')?>" class="btn btn-info btn-xs pull-right"> Add Slider</a>          
        </div>        
                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="<?=base_url('index.php/adminpanel/slider/details/'.$row->id)?>">Details</a></li> -->
                        <li><a href="<?=base_url('index.php/adminpanel/slider/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('index.php/adminpanel/slider/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Slider?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
