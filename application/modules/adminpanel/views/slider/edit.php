    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('index.php/adminpanel/slider/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Slider</a>
        ...
        <?php echo form_open_multipart("index.php/adminpanel/slider/edit/".$info->id);?>
          <div class="box-body">            
