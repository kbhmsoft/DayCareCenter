    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/category/add')?>" class="btn btn-info btn-xs pull-right"> Add Category</a>          
        </div>        
                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="<?=base_url('admin/category/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/category/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this category?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
