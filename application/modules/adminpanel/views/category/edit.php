  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <?php echo form_open_multipart("admin/category/edit/".$info->id);?>
          <div class="box-body">            
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="title" value="<?=set_value('title')?>">
                        <option value='<?=set_value('title', $info->title)?>'><?php if(set_value('title')){echo set_value('title');}else{ echo $info->title;}?></option>
