   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-primary">
            ...
            <?php echo form_open_multipart("adminpanel/general_setting/designation_add");?>
            <div class="box-body">
               ...
               <div class="row">
                  <div class="col-md-7">
                     ...
                     <div class="form-group">
                        <label>Designation Name(English)</label>
                        <div><?php echo form_error('desig_name_en'); ?></div>
                        <input type="text" name="desig_name_en" value="<?=set_value('desig_name_en')?>"  class="form-control">
                     </div> 

                     <div class="form-group">
                        <label>Designation Name(Bangla)</label>
                        <div><?php echo form_error('desig_name_bn'); ?></div>
                        <input type="text" name="desig_name_bn" value="<?=set_value('desig_name_bn')?>" class="bangla form-control">
                     </div> 
