                              ...
                              <td> 
                                 <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                       <!-- <li><a href="<?=base_url('adminpanel/social_/details/'.$row->id)?>">Details</a></li> -->
                                       <li><a href="<?=base_url('adminpanel/general_setting/social_icon_edit/'.$row->id)?>">Edit</a></li>
                                       <li><a href="<?=base_url('adminpanel/general_setting/social_icon_delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a></li>
                                    </ul>
                                 </div>
                              </td>
                           </tr>
