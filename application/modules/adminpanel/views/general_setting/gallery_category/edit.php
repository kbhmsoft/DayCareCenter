    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('adminpanel/general_setting/gallery_category')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Gallery Category</a>
        ...
        <?php echo form_open_multipart("adminpanel/general_setting/gallery_category_edit/".$info->id);?>
          <div class="box-body">            
