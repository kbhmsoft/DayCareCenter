    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('index.php/adminpanel/gallery/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Gallery</a>
          <a href="<?=base_url('index.php/adminpanel/gallery/add')?>" class="btn btn-info btn-xs pull-right"> Add Gallery</a> 
        </div>        
