...
$route['under-construction'] = 'site/under_construction';
...
$route['new-application/(:any)/(:any)'] = 'site/newapplication/$1/$2';
$route['subsidary-application/(:any)/(:any)'] = 'site/subsidary_application/$1/$2';
$route['payment/(:any)/(:any)'] = 'site/payment/$1/$2';
// $route['payment/(:any)'] = 'site/payment/$1';

// $route['newapplication/(:any)'] = 'Site2/newapplication/$1';
...
$route['mental-growth'] = 'site/mental_growth';
$route['physical-growth'] = 'site/physical_growth';
$route['primary-health-2'] = 'site/primary_health_2';

$route['entertainment-art'] = 'site/entertainment_art';
$route['food'] = 'site/food';
$route['art'] = 'site/art';
$route['security'] = 'site/security';
...
$route['child-mental-health-instruction'] = 'site/child_mental_health_instruction';
